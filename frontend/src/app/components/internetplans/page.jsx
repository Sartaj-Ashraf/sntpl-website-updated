...
const PricingPlans = () => {
  const plans = [
    ...
    },
    {
      ...
      price: "₹1000",
      description:
        "Balanced business plan offering good value with substantial data and speed.",
      badge: "Best Value",
      features: [
        "1000GB total data (500GB + 500GB bonus)",
        "Up to 150Mbps speed",
        "24/7 support included",
        "Rs 2000 installation charges",
        "2 Mbps post FUP speed",
    ...
    },
    {
      ...
      price: "₹800",
      description:
        "Essential business plan for small offices with moderate internet requirements.",
      badge: null,
      features: [
        "375GB total data (300GB + 75GB bonus)",
        "Up to 150Mbps speed",
        "24/7 support included",
        "Rs 2000 installation charges",
        "1 Mbps post FUP speed",
    ...
    },
    {
      ...
      price: "₹600",
      description:
        "Entry-level business plan for basic office connectivity and essential operations.",
      badge: null,
      features: [
        "200GB total data (150GB + 50GB bonus)",
        "Up to 150Mbps speed",
        "24/7 support included",
        "Rs 2000 installation charges",
        "Basic business connectivity",
  ...
  return (
    <section className="bg-white py-16 px-6 md:px-12 lg:px-20 overflow-hidden">
      {/* Max-width set to 1280px to align with standard modern navbars */}
      <div className="max-w-[1280px] mx-auto">
        {/* Main Title */}
        <div className="text-center mb-16">
          <h2 className="text-black text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
          {plans.map((plan, index) => (
            <div
              key={index}
              className="relative bg-black rounded-[40px] p-8 border-[3px] border-[#2FADE6] flex flex-col h-full w-full transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_20px_50px_rgba(47,173,230,0.2)]"
            >
              {/* Badge */}
              {plan.badge && (
                <div className="absolute -top-5 left-8 bg-[#2FADE6] text-black text-xs font-black uppercase px-4 py-2 rounded-xl shadow-lg z-10">
                  {plan.badge}
                </div>
              )}
              ...
              {/* Action Button */}
              <button className="w-full py-4 bg-white text-black font-bold rounded-2xl hover:bg-[#2FADE6] hover:text-white transition-all transform active:scale-95 mt-auto">
                Choose Plan
              </button>
            </div>
          ))}
