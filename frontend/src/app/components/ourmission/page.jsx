    ...
    <section className="w-full bg-white py-16 md:py-24 lg:py-32 px-6 lg:px-40 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="flex flex-col items-center  text-center lg:text-left space-y-8">
          {/* Target/Icon Image (ourmission3) - Exact Figma Dimensions */}
          <div className="relative w-[130px] h-[142px] md:w-[173.19px] md:h-[188.9px]">
            <Image
              src={ourmission3}
              alt="Mission Icon"
              fill
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-500 text-lg md:text-xl leading-relaxed max-w-md">
              Building resilient networks that support growth, reliability, and
